...
<form action="{{ $route }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
                ...
                @foreach ($locales as $locale)
                    ...
                    <div class="tab-pane @if ($loop->first) active @endif"
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="{{ $locale->locale }}-meta_title">@lang('common.metaTitle')</label>
                                    <input
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label" for="{{ $locale->locale }}-meta_description">@lang('common.metaDescription')</label>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="{{ $locale->locale }}-og_title">@lang('common.ogTitle')</label>
                                    <input
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label" for="{{ $locale->locale }}-og_description">@lang('common.ogDescription')</label>
        ...
        <div class="aside-lg">
            ...
            <div class="card mb-3">
                <div class="card-header">@lang('admin.categories')</div>
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" id="category" name="categories[]" multiple>
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}"
                                    @if (($post && in_array($category->id, $post->categories->pluck('id')->toArray())) ||
