<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">@lang('admin.managePages')</div>
                        ...
                        <tbody>
                            @forelse ($pages as $page)
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        @if ($page->published === 1)
                                            <span class="badge bg-success rounded-pill"> @lang('common.active') </span>
                                        @else
                                            <span class="badge bg-danger rounded-pill">@lang('common.inactive')</span>
                                        @endif
                                    </td>
