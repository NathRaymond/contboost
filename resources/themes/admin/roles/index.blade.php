<x-app-layout>
    ...
    <div class="row match-height">
        <div class="col-md-3">
            <ul class="card nav nav-justified nav-pills admin-pill-nav d-block" role="navigation">
                @foreach ($roles as $roleData)
                    <li class="w-100 nav-item{{ $role->id == $roleData->id ? ' selected' : '' }}">
                        <a class="name" href="{{ route('admin.roles', $roleData->id) }}">
                            <div>
        ...
        <div class="col-md-9">
            <form class="card" method="post" action="{{ route('admin.role.action') }}">
                <div class="card mb-3">
