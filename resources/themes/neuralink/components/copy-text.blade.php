...
<x-button type="button" class="copy-clipboard btn btn-link text-body" data-clipboard-text="{{ $text }}"
    data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('common.copyToClipboard') }}"
    data-title-copied="@lang('common.copied')">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 368 512" width="16">
        <path
