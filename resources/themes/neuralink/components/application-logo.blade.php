@if (empty(setting('website_logo')) ||
        setting('website_logo', 'themes/neuralink/images/logo.svg') == 'themes/neuralink/images/logo.svg')
...
@else
    <img height="30" class="logo-light" src="{{ url(setting('website_logo')) }}" alt="{{ config('app.name') }}" />
    @if (!empty(setting('website_logo_dark')))
        <img height="30" class="logo-dark" src="{{ url(setting('website_logo_dark')) }}"
            alt="{{ config('app.name') }}" />
    @endif
@endif
