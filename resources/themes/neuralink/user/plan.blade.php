<x-user-profile heading="h1" :title="__('profile.plan')" :hero-class="$user->subscription ? '' : 'center mt-5'">
    @if ($user->subscription)
        <div class="row">
            <div class="col-md-6">
                <h5>@lang('document.plan')</h5>
                <div class="text-muted">{{ $plan->name }}</div>
            </div>
            <div class="col-md-6">
                <h5>@lang('document.processor')</h5>
                <div class="text-muted">{{ ucfirst($subscription->payment_gateway) }}</div>
            </div>
            <div class="col-md-6 mt-3">
                <h5>@lang('document.amount')</h5>
                <div class="text-muted">
                    <x-money :currency="$subscription->currency" :amount="$subscription->amount" convert /> / {{ $subscription->plan_type }}
                </div>
            </div>
            <div class="col-md-6 mt-3">
                <h5>@lang('document.expiryDate')</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="list-check mb-0">
                    ...
                    <li class="@if ($plan->is_support == 1) check @else cross @endif">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a class="btn btn-danger rounded-pill ps-5 pe-5 mt-3"
                    href="{{ route('plans.cancel.subscription') }}">@lang('document.cancelSubscription')</a>
            </div>
        </div>
    @else
        <div class="row text-center">
            <div class="col-md-12 mb-3">
                <p>@lang('document.noSubscription')</p>
            </div>
            ...
            <div class="col-md-12">
                <a class="btn btn-success rounded-pill px-4" href="{{ route('plans.list') }}">@lang('document.subscribeNow')</a>
            </div>
        </div>
    @endif
</x-user-profile>
