<x-user-profile :title="__('document.transactionsList')">
    <table class="table table-style">
        <thead>
            <tr>
                <th>#</th>
                <th><span class="ps-2">@lang('document.plan')</span></th>
                <th>@lang('document.subscriptionDate')</th>
                <th>@lang('document.expiryDate')</th>
                <th>@lang('document.status')</th>
                <th>@lang('document.invoice')</th>
            </tr>
        </thead>
        <tbody>
