...
class App
{
    ...
    private function setEnvVariables($data)
    {
        ...
        $facebook_redirect = secure_url(URL::route('social.redirect', ['provider' => 'facebook'], false));
        $google_redirect = secure_url(URL::route('social.redirect', ['provider' => 'google'], false));
