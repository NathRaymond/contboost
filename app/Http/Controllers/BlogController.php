...
class BlogController extends Controller
{
    ...
    {
        $post = Post::withTranslation()->published()->slug($slug)->firstOrFail();
    ...
    {
        $category = Category::slug($category)->withTranslation()->active()->firstOrFail();
    ...
    {
        $tag = Tag::slug($tag)->withTranslation()->active()->firstOrFail();
